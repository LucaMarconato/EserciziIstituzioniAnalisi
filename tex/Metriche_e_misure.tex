...
\begin{proof}
  \begin{enumerate}
    ...
    Sia quindi $\ico{a}{b}=\bigsqcup_{k=1}^{n}\ico{a_k}{b_k}$; a meno di un riordinamento \footnote{e forse di intervalli vuoti?} possiamo supporre che per
    $2\leq k\leq n\ b_k=a_{k-1};\ a_1=a=b_0, b_n=b$.

    Allora $\mu_g(\ico{a}{b})=g(b)-g(a)=\sum_{k=1}^n (g(b_k)-g(b_{k-1}))=\sum_{k=1}^n (g(b_k)-g(a_k))=\sum_{k=1}^n \mu_g(\ico{a_k}{b_k})$.
