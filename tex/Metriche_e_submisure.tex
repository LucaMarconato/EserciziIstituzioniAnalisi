...
\begin{proof}
  \begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item[$\subseteq$] Basta mostrare che $\mathfrak{U}$ è un anello e che contiene $\gA\cup\gN$; $\gA\subseteq\mathfrak{U}$ perché ogni elemento $A$ di $\gA$ si scrive come $A\Delta \emptyset$, e analgamente  $\gN\subseteq\mathfrak{U}$ Perché ogni elemento $N$ di $\gN$ si scrive come $N\Delta \emptyset$.
      ...
      \begin{itemize}
        ...
        \item[$\setminus$] Mostriamo che ogni elemento di $\mathfrak{T}=\mathfrak{U}$ appartiene a $\mathfrak{U}$. Siano $A\sqcup N, A_1\sqcup N_1\in\mathfrak{U}$; allora $(A\sqcup N) \setminus (A_1\sqcup N_1)=(A\setminus A_1\setminus N_1) \sqcup (N\setminus (A_1\setminus N_1)$.
